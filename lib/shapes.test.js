...
describe('Triangle', () => {
    it('should render the correct svg from user input', () => {
        ...
        expect(triangle.svgString.trim()).toEqual(expectedOutput.trim())
    })
})
...
describe('Square', () => {
    it('should render the correct svg from user input', () => {
        ...
        expect(square.svgString.trim()).toEqual(expectedOutput.trim())
    })
})
...
describe('Circle', () => {
    it('should render the correct svg from user input', () => {
      ...
      `
        expect(circle.svgString.trim()).toEqual(expectedOutput.trim())
    })
})