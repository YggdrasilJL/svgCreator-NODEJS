...
describe('Shape', () => {
    // testing to make sure Shape has the correct properties that are in shapes.js
...
describe('Triangle', () => {
    it('should render the correct svg from user input', () => {
     ...
     // testing what the expected output should be
      ...
      // using the renderShape function to call the svgString defined in shapes.js
