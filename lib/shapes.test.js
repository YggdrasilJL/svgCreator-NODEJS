...
describe('Triangle', () => {
    it('should render the correct svg from user input', () => {
        ...
        <text x="50%" y="70%" dominant-baseline="middle" text-anchor="middle" fill="orange">
          inc
        </text>
      </svg>`
        expect(triangle).toEqual(expectedOutput)
    })
})
...
describe('Square', () => {
    it('should render the correct svg from user input', () => {
        ...
        expect(square.svgString).toEqual(expectedOutput)
    })
})
...
describe('Circle', () => {
    it('should render the correct svg from user input', () => {
      ...
      `
        expect(circle.svgString).toEqual(expectedOutput)
    })
})